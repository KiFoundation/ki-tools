...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a kid testnet",
...
Example:
	kid testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "kid",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "kicli",
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	for i := 0; i < numValidators; i++ {
		...
		gaiaConfigFilePath := filepath.Join(nodeDir, "config/kid.toml")

...
to delegate Atoms at launch. This is because the kid tool used in the guide
...
- Download software directly from official sources, and make sure that you’re
  always using the latest, most secure version of kid when you’re doing
  anything that involves your 12 words. The latest versions of Tendermint, the
  Cosmos-SDK, and kid will always be available from our official GitHub
...
[cli]: https://github.com/cosmos/cosmos-sdk/blob/develop/docs/kitools/delegator-guide-cli.md

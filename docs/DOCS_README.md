...
If you want to open a PR on Gaia to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/cosmos/kitools/tree/main/CONTRIBUTING.md)
...
built from the files in this (`/docs`) directory for [main](https://github.com/cosmos/kitools/tree/main/docs).

### How It Works

There is a [Github Action](https://github.com/cosmos/kitools/blob/main/.github/workflows/docs.yml)
...
[Makefile](https://github.com/cosmos/kitools/blob/main/Makefile) in this repo.
...
1. Execute the following command at the root directory to install the swagger-ui generate tool.
   ...
   ```
2. Edit API docs
   1. Directly Edit API docs manually: `cmd/kid/swagger-ui/swagger.yaml`.
   2. Edit API docs within the [Swagger Editor](https://editor.swagger.io/). Please refer to this [document](https://swagger.io/docs/specification/2-0/basic-structure/) for the correct structure in `.yaml`.
3. Download `swagger.yaml` and replace the old `swagger.yaml` under fold `cmd/kid/swagger-ui`.
4. Compile kid
   ```bash
   make install
   ```

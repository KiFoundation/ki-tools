...
You can query the proposal details with the kid command-line interface using this command: `kid q gov proposal 23 --chain-id cosmoshub-3 --node cosmos-node-1.figment.network:26657`

You use can also use [Hubble](https://hubble.figment.network/cosmos/chains/cosmoshub-3/blocks/424035/transactions/B8E2662DE82413F03919712B18F7B23AF00B50DAEB499DAD8C436514640EFC79?format=json) or kid to query the transaction that I sent to create this proposal on-chain in full detail: `kid q tx B8E2662DE82413F03919712B18F7B23AF00B50DAEB499DAD8C436514640EFC79 --chain-id cosmoshub-3 --node cosmos-node-1.figment.network:26657`
...
You can query the proposal details with the kid command-line interface using this command: `kid q gov proposal 30 --chain-id kitools-13007 --node 45.77.218.219:26657`

You use can also use [Hubble](https://hubble.figment.network/cosmos/chains/kitools-13007/transactions/B5AB56719ADB7117445F6E191E1FCE775135832AFE6C9922B8703AADBC4B13F3?format=json) or kid to query the transaction that I sent to create a similar proposal on-chain in full detail: `kid q tx B5AB56719ADB7117445F6E191E1FCE775135832AFE6C9922B8703AADBC4B13F3 --chain-id kitools-13007 --node 45.77.218.219:26657`

...
- [`kitools` 애플리케이션 설치하기](./kitools-tutorials/installation.md)
- [풀노드를 세팅하고 현재 퍼블릭 테스트넷 참가하기](./kitools-tutorials/join-testnet.md)
- [벨리데이터 노드로 업그레이드 하기](./validators/validator-setup.md)

## 자체 `kitools` 테스트넷 세팅하기

- [자체 `kitools` 테스트넷 세팅하기](./kitools-tutorials/deploy-testnet.md)

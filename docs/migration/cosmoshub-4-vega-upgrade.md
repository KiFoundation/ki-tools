...
The Comsos Hub mainnet network, `cosmoshub-4`, will run [Gaia v6.0.0](https://github.com/cosmos/kitools/releases/tag/v6.0.0). Operators _MUST_ use this version post-upgrade to remain connected to the network.
